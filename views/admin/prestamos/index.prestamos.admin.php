...
<div class="container-fluid">
    ...
    <h4 class="mt-4">
        Prestamos 
        <a class="btn btn-primary" href="/inventarios/prestamos/admin/create">
        ...
        <tbody>
            <?php
                ...
                foreach (selectCustom($query) as $column) {
                    ...
                    echo "
                    <a class='btn btn-primary' href='/inventarios/prestamos/admin/$id/show'>
                        <i class='fa fa-eye'></i>
                    </a>";
                    echo "
                    <a class='btn btn-success' href='/inventarios/prestamos/admin/$id/retorno'>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'GET',
                        dataType: 'json',
                        url: '/inventarios/prestamos/admin/'+id+'/delete',
