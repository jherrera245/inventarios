...
<div class="container-fluid">
    <form action="/inventarios/prestamos/admin/save" method="post">
        ...
        <div class="card mt-4">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="practicante" class="form-label fw-bold">Practicante</label>
                            <select class="form-control" name="practicante" id="practicante">
                                <?php 
                                    foreach(selectAll("practicantes") as $practicante){
                                        echo "<option value='".$practicante['id']."'>".$practicante["nombres"]." ".$practicante["apellidos"]."</option>";
                                    }
                                ?>
                            </select>
                        </div>
            ...
            <div class="card-footer">
                ...
                <a href="/inventarios/prestamos/admin" class="btn btn-secondary">
